...
recommendation_rows.each do |row|
  ...
  @hosts.each do |host|
    ...
    recommendations.each_with_index do |recommendation,index|
      ...
      $redis.sadd 'recommendations', recommendation_id
      $redis.sadd "recommendations_from_episode:#{episode_id}", recommendation_id
      $redis.sadd "recommendations_from_host:#{host_id}", recommendation_id
